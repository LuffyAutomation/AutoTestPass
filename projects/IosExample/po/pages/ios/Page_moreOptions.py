# coding: utf-8
from projects.IosExample.po.models.ios.Page_moreOptions_model import Page_moreOptions_model


'''.'''
class Page_moreOptions(Page_moreOptions_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_moreOptions_model.__init__(self)
