# coding: utf-8
from projects.IosExample.po.models.ios.Page_personalizeIcon_model import Page_personalizeIcon_model


'''personalizeIcon'''
class Page_personalizeIcon(Page_personalizeIcon_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_personalizeIcon_model.__init__(self)
