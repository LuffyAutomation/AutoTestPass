# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_addAccount_pageFiles_model import Page_addAccount_pageFiles_model


'''This screen is add account from files page'''
class Page_addAccount_pageFiles(Page_addAccount_pageFiles_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_addAccount_pageFiles_model.__init__(self)
