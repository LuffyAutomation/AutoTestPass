# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_googleDriveSafari_model import Page_googleDriveSafari_model


'''Google Drive safari'''
class Page_googleDriveSafari(Page_googleDriveSafari_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_googleDriveSafari_model.__init__(self)
