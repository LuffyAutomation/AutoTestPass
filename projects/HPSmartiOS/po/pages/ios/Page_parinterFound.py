# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_parinterFound_model import Page_parinterFound_model


''''''
class Page_parinterFound(Page_parinterFound_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_parinterFound_model.__init__(self)
