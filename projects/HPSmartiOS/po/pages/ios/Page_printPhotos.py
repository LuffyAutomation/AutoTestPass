# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_printPhotos_model import Page_printPhotos_model


''''''
class Page_printPhotos(Page_printPhotos_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_printPhotos_model.__init__(self)
