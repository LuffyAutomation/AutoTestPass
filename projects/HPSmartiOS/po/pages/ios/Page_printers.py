# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_printers_model import Page_printers_model


'''all printer list screen'''
class Page_printers(Page_printers_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_printers_model.__init__(self)
