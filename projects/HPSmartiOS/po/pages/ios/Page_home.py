# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_home_model import Page_home_model
...
class Page_home(Page_home_model):
    ...
    def verifyHomeIsDisplayed(self):
        self.button_home().verifyIsShown()
        print "Home screen is shows."

    def verifySomeTiles(self):
        self.tile_Scan().verifyIsNotShown()
        self.tile_Personalize().verifyIsNotShown()
        self.tile_PrinterSettings().verifyIsNotShown()
