# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_printerInfor_model import Page_printerInfor_model


'''touch printer image'''
class Page_printerInfor(Page_printerInfor_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_printerInfor_model.__init__(self)
