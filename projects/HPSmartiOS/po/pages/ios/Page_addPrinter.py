# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_addPrinter_model import Page_addPrinter_model


''''''
class Page_addPrinter(Page_addPrinter_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_addPrinter_model.__init__(self)
