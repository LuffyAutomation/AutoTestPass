# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_mainHome_model import Page_mainHome_model


'''Mobility phone home screen'''
class Page_mainHome(Page_mainHome_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_mainHome_model.__init__(self)
