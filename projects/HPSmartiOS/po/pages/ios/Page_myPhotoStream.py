# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_myPhotoStream_model import Page_myPhotoStream_model


''''''
class Page_myPhotoStream(Page_myPhotoStream_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_myPhotoStream_model.__init__(self)
