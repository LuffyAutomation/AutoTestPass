# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_myPhotos_model import Page_myPhotos_model


''''''
class Page_myPhotos(Page_myPhotos_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_myPhotos_model.__init__(self)
