# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_scanComplete_model import Page_scanComplete_model


''''''
class Page_scanComplete(Page_scanComplete_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_scanComplete_model.__init__(self)
