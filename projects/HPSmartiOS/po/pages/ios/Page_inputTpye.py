# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_inputTpye_model import Page_inputTpye_model


'''Touch inputType go to there'''
class Page_inputTpye(Page_inputTpye_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_inputTpye_model.__init__(self)

    def verifyInputScreen(self):
        self.text_JPG().verifyIsShown()
        self.text_PDF().verifyIsShown()
