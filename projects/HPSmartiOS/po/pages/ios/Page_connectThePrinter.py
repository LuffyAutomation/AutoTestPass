# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_connectThePrinter_model import Page_connectThePrinter_model


'''Touch Add printer button from printers page.'''
class Page_connectThePrinter(Page_connectThePrinter_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_connectThePrinter_model.__init__(self)
