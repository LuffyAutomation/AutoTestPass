# coding: utf-8
from projects.HPSmartiOS.po.models.ios.Page_GoogleDrive_model import Page_GoogleDrive_model


''''''
class Page_GoogleDrive(Page_GoogleDrive_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.IosFwk import IosFwk
            self.UI = IosFwk(None)
        Page_GoogleDrive_model.__init__(self)
