# coding: utf-8
from projects.WebMultipleThreads.po.models.android.Page_other_model import Page_other_model


'''main page.'''
class Page_other(Page_other_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk(None)
        Page_other_model.__init__(self)
