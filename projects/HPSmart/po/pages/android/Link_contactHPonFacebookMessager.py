# coding: utf-8
from projects.HPSmart.po.models.android.Link_contactHPonFacebookMessager_model import Link_contactHPonFacebookMessager_model


'''contact HP on facebook messager page.'''
class Link_contactHPonFacebookMessager(Link_contactHPonFacebookMessager_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk(None)
        Link_contactHPonFacebookMessager_model.__init__(self)
