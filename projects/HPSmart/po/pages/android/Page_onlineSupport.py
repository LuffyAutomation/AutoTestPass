# coding: utf-8
from projects.HPSmart.po.models.android.Page_onlineSupport_model import Page_onlineSupport_model


'''OnlineSupport page.'''
class Page_onlineSupport(Page_onlineSupport_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk(None)
        Page_onlineSupport_model.__init__(self)
